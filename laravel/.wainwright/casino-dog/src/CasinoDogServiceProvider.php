...
class CasinoDogServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        $package
            ...
            ->hasCommands(DatabaseObserve::class, RetrieveDefaultGameslist::class, StoreDefaultGameslist::class, CreateGameProvider::class, AddOperatorAccessKey::class, AutoConfigCasinoDog::class, InstallCasinoDog::class, MigrateCasinoDog::class);
